...
export const metadata: Metadata = {
    ...
    description: 'Last War is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Last War accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Last War accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Last War is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Last War presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Last War. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@lastwar.fr</strong></li>
                </ul>
                <p>
