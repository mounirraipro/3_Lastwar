...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Last War uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Last War cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Last War uses them, and how you can
                ...
                <p>Last War uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Last War.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@lastwar.fr</strong>.
                </p>
            </div>
        </>
    );
