...
export const metadata: Metadata = {
    ...
    description: 'Read the Last War Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Last War terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Last War. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Last War at lastwar.fr, you acknowledge that you have read,
                ...
                <p>
                    Last War provides a free, browser-based game. Last War is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Last War is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Last War — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Last War or its
                ...
                <p>
                    ...
                    Last War for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Last War, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Last War a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Last War displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Last War is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Last War and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Last War at our sole
                ...
                <p>
                    ...
                    <strong>legal@lastwar.fr</strong>.
                </p>
            </div>
        </>
    );
